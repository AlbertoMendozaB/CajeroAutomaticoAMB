...
PesosColombianos(){
    ...
    let pesos_colombianos = new Intl.NumberFormat('es-CO', {
        style: 'currency',
        currency: 'COP',
    });

    let total_ingresos = document.getElementById("total_ingresos");
    total=0;
    ingresos.forEach(function(ingreso){
        total += ingreso;
    })
    console.log("Ingresos: " + ingresos);
    total_ingresos.innerHTML = "Total ingresos : " + pesos_colombianos.format(total);
